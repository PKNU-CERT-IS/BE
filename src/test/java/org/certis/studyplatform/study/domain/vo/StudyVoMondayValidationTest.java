...
class StudyVoMondayValidationTest {
    ...
    class MondayValidationTest {
        ...
        void createStudyWithMondayStartDate_ShouldPass() {
            ...
            OffsetDateTime sundayEnd = mondayStart.plusWeeks(4).with(DayOfWeek.SUNDAY).withHour(23).withMinute(59).withSecond(59).withNano(0);

            // When & Then
            assertThatCode(() -> StudyVo.of(
                    null, "테스트 스터디", "설명", "내용", "카테고리", "하위카테고리",
                    mondayStart, sundayEnd, OffsetDateTime.now(), OffsetDateTime.now(),
        ...
        void createStudyWithNonMondayStartDate_ShouldThrowException() {
            ...
            OffsetDateTime sundayEnd = tuesdayStart.plusWeeks(4).with(DayOfWeek.SUNDAY).withHour(23).withMinute(59).withSecond(59).withNano(0);

            // When & Then
            assertThatThrownBy(() -> StudyVo.of(
                    null, "테스트 스터디", "설명", "내용", "카테고리", "하위카테고리",
                    tuesdayStart, sundayEnd, OffsetDateTime.now(), OffsetDateTime.now(),
                    1L, "생성자", MemberGrade.SENIOR, null, "2024-01", "READY",
                    ResultSubmitStatus.READY, 5, 0, true, Collections.emptyList()
            )).isInstanceOf(DomainException.class)
                    .hasMessageContaining("스터디 시작일은 월요일이어야 합니다");
        }
        ...
        void validateVariousDaysOfWeek() {
            ...
            OffsetDateTime sundayEnd = monday.plusWeeks(4).with(DayOfWeek.SUNDAY).withHour(23).withMinute(59).withSecond(59).withNano(0);

            // When & Then
            // 월요일 시작일은 정상 처리
            assertThatCode(() -> StudyVo.of(
                    null, "테스트 스터디", "설명", "내용", "카테고리", "하위카테고리",
                    monday, sundayEnd, OffsetDateTime.now(), OffsetDateTime.now(),
                    1L, "생성자", MemberGrade.SENIOR, null, "2024-01", "READY",
                    ResultSubmitStatus.READY, 5, 0, true, Collections.emptyList()
            )).doesNotThrowAnyException();
            ...
            assertThatThrownBy(() -> StudyVo.of(
                    null, "테스트 스터디", "설명", "내용", "카테고리", "하위카테고리",
                    tuesday, sundayEnd, OffsetDateTime.now(), OffsetDateTime.now(),
                    1L, "생성자", MemberGrade.SENIOR, null, "2024-01", "READY",
                    ResultSubmitStatus.READY, 5, 0, true, Collections.emptyList()
            )).isInstanceOf(DomainException.class);
            ...
            assertThatThrownBy(() -> StudyVo.of(
                    null, "테스트 스터디", "설명", "내용", "카테고리", "하위카테고리",
                    wednesday, sundayEnd, OffsetDateTime.now(), OffsetDateTime.now(),
                    1L, "생성자", MemberGrade.SENIOR, null, "2024-01", "READY",
                    ResultSubmitStatus.READY, 5, 0, true, Collections.emptyList()
            )).isInstanceOf(DomainException.class);
            ...
            assertThatThrownBy(() -> StudyVo.of(
                    null, "테스트 스터디", "설명", "내용", "카테고리", "하위카테고리",
                    thursday, sundayEnd, OffsetDateTime.now(), OffsetDateTime.now(),
                    1L, "생성자", MemberGrade.SENIOR, null, "2024-01", "READY",
                    ResultSubmitStatus.READY, 5, 0, true, Collections.emptyList()
            )).isInstanceOf(DomainException.class);
            ...
            assertThatThrownBy(() -> StudyVo.of(
                    null, "테스트 스터디", "설명", "내용", "카테고리", "하위카테고리",
                    friday, sundayEnd, OffsetDateTime.now(), OffsetDateTime.now(),
                    1L, "생성자", MemberGrade.SENIOR, null, "2024-01", "READY",
                    ResultSubmitStatus.READY, 5, 0, true, Collections.emptyList()
            )).isInstanceOf(DomainException.class);
            ...
            assertThatThrownBy(() -> StudyVo.of(
                    null, "테스트 스터디", "설명", "내용", "카테고리", "하위카테고리",
                    saturday, sundayEnd, OffsetDateTime.now(), OffsetDateTime.now(),
                    1L, "생성자", MemberGrade.SENIOR, null, "2024-01", "READY",
                    ResultSubmitStatus.READY, 5, 0, true, Collections.emptyList()
            )).isInstanceOf(DomainException.class);
            ...
            assertThatThrownBy(() -> StudyVo.of(
                    null, "테스트 스터디", "설명", "내용", "카테고리", "하위카테고리",
                    sunday, sundayEnd, OffsetDateTime.now(), OffsetDateTime.now(),
                    1L, "생성자", MemberGrade.SENIOR, null, "2024-01", "READY",
                    ResultSubmitStatus.READY, 5, 0, true, Collections.emptyList()
            )).isInstanceOf(DomainException.class);
        }

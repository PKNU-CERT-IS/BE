...
class AdminStudyEndFlowTest {
    ...
    void reject_end_clears_submission_fields() throws Exception {
        ...
        var rec = dsl.fetchOne("select result_submit_status, result_attached_url, result_submitted_at from study where id = ?", STUDY_ID);
    ...
    void get_submission_returns_payload() throws Exception {
        ...
        mockMvc.perform(get(ADMIN_BASE + "/end/" + STUDY_ID))
                .andDo(print())
                .andExpect(status().isOk())

...
//
//    @PostMapping
//    public ResponseEntity<MemberInfoResponseDto> createMember(@Valid @RequestBody CreateMemberRequestDto request) {
//        Member newMember = memberApplicationService.createMember(request);
//        return ResponseEntity.status(HttpStatus.CREATED).body(MemberInfoResponseDto.fromDomain(newMember));
//    }

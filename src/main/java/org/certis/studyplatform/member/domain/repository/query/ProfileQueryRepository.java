...
public interface ProfileQueryRepository {
     ...
     * @return 스터디 VO 목록
     */
    List<ProfileStudyVo> findStudiesByMemberId(Long memberId);
     ...
     * @return 프로젝트 VO 목록
     */
    List<ProfileProjectVo> findProjectsByMemberId(Long memberId);
     ...
     * @return 블로그 VO 목록
     */
    List<ProfileBlogVo> findBlogsByMemberId(Long memberId);
     ...
     * @return 참여 중인 스터디 개수
     */
    long countStudiesByMemberId(Long memberId);
     ...
     */
    long countProjectsByMemberId(Long memberId);
     ...
     * @return 작성한 블로그 개수
     */
    long countBlogsByMemberId(Long memberId);
     ...
     * @return 활동 요약 정보
     */
    ActivitySummaryVo getRecentActivitySummary(Long memberId);
}
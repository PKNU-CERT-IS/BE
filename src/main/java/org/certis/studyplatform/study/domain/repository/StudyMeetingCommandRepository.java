...
/**
 * Study Meeting Command Repository Interface
 *
 ...
 */
public interface StudyMeetingCommandRepository {

    /**
     * 스터디 회의록 생성
     *
     * @param studyMeetingVo 저장할 회의록 VO
     * @return 생성된 회의록 결과 VO
     */
    StudyMeetingCreatedVo save(StudyMeetingVo studyMeetingVo);
     ...
     *
     * @param studyMeetingVo 수정할 회의록 VO (null 필드는 기존 값 유지)
     * @return 수정된 회의록 결과 VO
     * @throws org.certis.studyplatform.exception.DomainException 회의록이 존재하지 않거나 권한이 없는 경우
     */
    StudyMeetingUpdatedVo update(StudyMeetingVo studyMeetingVo);

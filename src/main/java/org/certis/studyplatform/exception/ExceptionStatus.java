...
public enum ExceptionStatus {
    ...
    PROJECT_DOMAIN_INVALID_START_DAY(HttpStatus.BAD_REQUEST, "프로젝트 시작일은 월요일이어야 합니다"),
    PROJECT_DOMAIN_INVALID_END_DAY(HttpStatus.BAD_REQUEST, "프로젝트 종료일은 일요일이어야 합니다"),
    ...
    STUDY_DOMAIN_INVALID_START_DAY(HttpStatus.BAD_REQUEST, "스터디 시작일은 월요일이어야 합니다"),
    STUDY_DOMAIN_INVALID_END_DAY(HttpStatus.BAD_REQUEST, "스터디 종료일은 일요일이어야 합니다"),
